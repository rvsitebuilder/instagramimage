...
mix.setResourceRoot('/vendor/rvsitebuilder/instagramimage');
...
// ============================ //
mix.js('resources/js/admin/ig-images.js', 'public/js/admin/app.js');
mix.copy('resources/sass/admin/ig-images.css', 'public/css/admin/app.css');
